...
namespace BIMarabiaCommandsWPF
{
    ...
    public class BIMarabiaPlugin : IExternalApplication
    {
        ...
        static readonly string tabName = "BIMarabia Plugin WPF";
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            try
            {
                ...
                PushButton elementPushButton = CreateButton("elementButton", "Get Element Info", typeof(GetElementInfo).FullName, $"{nameof(BIMarabiaCommandsWPF)}.Resources.Info.png", elementPanel, "Get full information about element.");

                // Create the "floor" panel.
                RibbonPanel floorPanel = application.CreateRibbonPanel(tabName, "Floor");

                // Create the "floor" button.
                PushButton floorPushButton = CreateButton("floorButton", "Floor from Walls", typeof(CreateFloorFromWallsContiguous).FullName, $"{nameof(BIMarabiaCommandsWPF)}.Resources.Floor.png", floorPanel, "Create floor by selecting walls.");
            }
            catch (Exception e)
            {
